...
def main(args) :
    ...
    positive_txt = CARZero_model.process_class_prompts(positive, "cuda:0")
    negative_txt = CARZero_model.process_class_prompts(negative, "cuda:0")
    
    p_logit, p_i2t_attn, p_t2i_attn = obtain_attn(image_csv, positive, CARZero_model, device="cuda:0", multi=cfg.model.CARZero.multi, mcq=cfg.model.CARZero.multi)
    n_logit, n_i2t_attn, n_t2i_attn = obtain_attn(image_csv, negative, CARZero_model, device="cuda:0", multi=cfg.model.CARZero.multi, mcq=cfg.model.CARZero.multi)
