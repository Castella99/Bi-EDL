...
from finetuning_lightening import MultiLabelMCQDQNWOSAMLPGLModel
from finetuning_dm import NIHMultiLabelMCQDataModule
...
def main(cfg) :
    ...
    model = MultiLabelMCQDQNWOSAMLPGLModel(cfg)
