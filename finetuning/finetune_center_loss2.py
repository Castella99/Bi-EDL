...
from finetuning_lightening import CenterLossDQNWOSAMLPGLModel
...
def main(cfg) :
    ...
    model = CenterLossDQNWOSAMLPGLModel(cfg)
    ...
    trainer = Trainer(
        ...
        callbacks=[
            ModelCheckpoint(
                ...
                filename="best_model_{epoch:02d}-{val/loss:.4f}",
                save_top_k=1,
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_center_loss_ver2.yaml')
