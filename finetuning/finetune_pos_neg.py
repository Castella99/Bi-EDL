...
from finetuning_lightening import PosNegDQNWOSAMLPGLModel
from finetuning_dm import NIHPosNegDataModule
...
def main(cfg) :
    ...
    model = PosNegDQNWOSAMLPGLModel(cfg)
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_PosNeg.yaml')
