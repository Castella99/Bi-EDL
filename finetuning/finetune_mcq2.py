...
from finetuning_lightening import MCQ2DQNWOSAMLPGLModel
from finetuning_dm import NIHMCQ2DataModule, NIHMultiLabelMCQDataModule
...
def main(cfg) :
    ...
    model = MCQ2DQNWOSAMLPGLModel(cfg)
    ...
    trainer = Trainer(
        ...
        callbacks=[
            ...
            EarlyStopping(monitor="val/bce_loss", patience=20, mode="min"),
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_MCQ2.yaml')
