...
from finetuning_lightening import MarginCONCLModel
from finetuning_dm import NIHPNPromptDataModule
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_MUL_CON_margin.yaml')
