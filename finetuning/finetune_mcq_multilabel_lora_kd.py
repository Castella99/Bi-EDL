...
from CARZero.finetuning_lightening import NIHMultiLabelMCQDataModule, LORAKDMCQCARZEROModel
...
def main(cfg) :
    ...
    model = LORAKDMCQCARZEROModel(cfg)
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_MCQ_LoRA_KD.yaml')
