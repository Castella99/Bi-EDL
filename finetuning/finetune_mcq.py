...
from finetuning_lightening import MCQDQNWOSAMLPGLModel
from finetuning_dm import NIHMCQDataModule, NIHMultiLabelMCQDataModule
...
def main(cfg) :
    ...
    model = MCQDQNWOSAMLPGLModel(cfg)
    ...
    trainer = Trainer(
        ...
        callbacks=[
            ...
            EarlyStopping(monitor="val/bce_loss", patience=10, mode="min"),
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_MCQ.yaml')
