...
from finetuning_lightening import MCQOnlyDQNWOSAMLPGLModel
...
def main(cfg) :
    ...
    model = MCQOnlyDQNWOSAMLPGLModel(cfg)
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('configs/chest14_finetuning_llm_dqn_wo_self_atten_mlp_gl_MCQ_Only.yaml')
